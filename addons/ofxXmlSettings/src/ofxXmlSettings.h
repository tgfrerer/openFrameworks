...
class ofxXmlSettings: public ofBaseFileSerializer{
	...
	protected:
		...
		bool 	readTag(const std::string&  tag, TiXmlHandle& valHandle, int which = 0);	// max 1024 chars...
        ...
        bool readIntAttribute(const std::string& tag, const std::string& attribute, int& valueString, int which);
