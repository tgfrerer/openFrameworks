...
void ofCairoRenderer::setup(std::string _filename, Type _type, bool multiPage_, bool b3D_, ofRectangle _viewport){
...
void ofCairoRenderer::draw(const std::vector<ofPoint> & vertexData, ofPrimitiveMode drawMode) const{
