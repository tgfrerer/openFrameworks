...
//--------------------------------------------------
void ofLogToFile(const std::string & path, bool append){
...
ofFileLoggerChannel::ofFileLoggerChannel(const std::string & path, bool append){
	setFile(path,append);
}
...
void ofFileLoggerChannel::setFile(const std::string & path,bool append){
